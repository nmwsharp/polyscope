...
static const std::vector<const Colormap*> allColormaps{&CM_VIRIDIS,  &CM_COOLWARM, &CM_PIYG,      &CM_BLUES, &CM_REDS,
                                                       &CM_SPECTRAL, &CM_RAINBOW,  &CM_CONST_RED, &CM_PHASE};
static const char* allColormapNames[] = {
    "viridis", "coolwarm", "purple-green", "blues", "reds", "spectral", "rainbow", "constant red", "phase",
};
...
// All quantitative colormaps
static const std::vector<const Colormap*> quantitativeColormaps{&CM_VIRIDIS, &CM_COOLWARM, &CM_PIYG, &CM_BLUES,
                                                                &CM_REDS};
static const char* quantitativeColormapNames[] = {"viridis", "coolwarm", "purple-green", "blues", "reds"};
