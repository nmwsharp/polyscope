...
TEST_F(PolyscopeTest, ManagedBufferAccess) {
  ...
  polyscope::render::ManagedBuffer<glm::vec3>& bufferPos =
      polyscope::render::getManagedBuffer<glm::vec3>("test_cloud1", "points");
  polyscope::render::ManagedBuffer<double>& bufferScalar =
      polyscope::render::getManagedBuffer<double>("test_cloud1", "vScalar", "values");
  ...
  // make sure we can get its buffers
  polyscope::render::ManagedBuffer<glm::vec4>& bufferColor=
      polyscope::render::getManagedBuffer<glm::vec4>("global", "im color", "colors");
