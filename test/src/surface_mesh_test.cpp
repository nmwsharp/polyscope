...
TEST_F(PolyscopeTest, SimpleTriangleMesUpdate) {
  ...
  psMesh->updateMesh(std::vector<glm::vec3>(4), std::vector<glm::uvec3>(4, glm::uvec3(0, 1, 2)));
  polyscope::show(3);

  // do a bunch of resizing
  psMesh->updateMesh(std::vector<glm::vec3>(12), std::vector<glm::uvec3>(4, glm::uvec3(0, 1, 2)));
  polyscope::show(3);

  psMesh->updateMesh(std::vector<glm::vec3>(3), std::vector<glm::uvec3>(4, glm::uvec3(0, 1, 2)));
  polyscope::show(3);

  psMesh->updateMesh(std::vector<glm::vec3>(3), std::vector<glm::uvec3>(14, glm::uvec3(0, 1, 2)));
  polyscope::show(3);

  psMesh->updateMesh(std::vector<glm::vec3>(3), std::vector<glm::uvec3>(1, glm::uvec3(0, 1, 2)));
  polyscope::show(3);
